...
function generateCredential(studentData) {
    ...
    // Aplicar estilos de máximo contraste directamente con tamaño correcto
    qrImage.style.cssText = `
        ...
        image-rendering: crisp-edges;
        image-rendering: -webkit-optimize-contrast;
        filter: contrast(300%) brightness(30%) saturate(0%);
        -webkit-filter: contrast(300%) brightness(30%) saturate(0%);
        background: #FFFFFF;
    ...
    printWindow.document.write(`
        ...
        <head>
            ...
            <style>
                ...
                @media print {
                    .qr-super-print {
                        filter: contrast(1000%) brightness(10%) saturate(0%) invert(0%) !important;
                        -webkit-filter: contrast(1000%) brightness(10%) saturate(0%) invert(0%) !important;
        ...
        <body>
            <div class="no-print">
                <div class="print-header">
                    ...
                    <button onclick="window.print()" style="background: #28a745; color: white; border: none; padding: 12px 25px; border-radius